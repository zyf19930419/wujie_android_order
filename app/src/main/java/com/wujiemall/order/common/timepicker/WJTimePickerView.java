 ...
 * 联系方式：常用邮箱或电话
 */
public class WJTimePickerView extends BasePickerView implements View.OnClickListener {

    private WheelTime wheelTime; //自定义控件
    private static final String TAG_SUBMIT = "submit";
    private static final String TAG_CANCEL = "cancel";

    public WJTimePickerView(PickerOptions pickerOptions) {
    ...
    private void initView(Context context) {
        ...
        if (mPickerOptions.customListener == null) {
            LayoutInflater.from(context).inflate(R.layout.dialog_date_picker, contentContainer);

            //顶部标题
            TextView tvTitle = (TextView) findViewById(R.id.tvTitle);
            View rv_top_bar = findViewById(R.id.rv_topbar);
